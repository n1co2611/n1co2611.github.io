...
const I18N = {
  es: {
    ...
    "about.p2":"Trabajo principalmente con Angular, Ionic, React, Vue.js, Firebase y TypeScript, y lo complemento con backend (Node.js, C#, PL/SQL) y experiencia real en sistemas mainframe —COBOL, JCL y DB2— adquirida durante mis prácticas en NTT Data. Esa combinación me da una perspectiva completa del software.",
  ...
  en: {
    ...
    "about.p2":"I mainly work with Angular, Ionic, React, Vue.js, Firebase and TypeScript, complemented by backend work (Node.js, C#, PL/SQL) and real mainframe experience —COBOL, JCL and DB2— from my internship at NTT Data. That combination gives me a complete view of software.",
